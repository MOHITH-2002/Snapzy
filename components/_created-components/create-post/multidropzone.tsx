...
const variants = {
  base: 'relative rounded-md p-4 w-96 w-[250px] flex justify-center items-center flex-col cursor-pointer border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out',
  active: 'border-2',
  disabled:
      ...
      <div>
        <div className="flex flex-col gap-2">
          ...
          {value?.map(({ file, abortController, progress }, i) => (
            <div
              key={i}
              className="flex h-16  w-[250px] flex-col justify-center rounded border border-gray-300 px-4 py-2"
            >
